...
import { about_us_our_story } from "../../utils/SiteImages/Images";
        ...
        <>
            <div className="our-story">
                <div className="mission-image">
                    <img className="mission-default-image" src={about_us_our_story} alt="mision-image" />
                </div>
                <div className="mission-content">
                    <div className="inner-text-story">
